...
public class App {
    ...
    public static void main(String[] args) {
        ...
        for (int firstLevel = 0; firstLevel < numbers.length; firstLevel++) {
            System.out.println("length firstLevel: " + numbers.length);
            for (int secondLevel = 0; secondLevel < numbers[firstLevel].length; secondLevel++) {
                System.out.println(numbers[firstLevel][secondLevel]);
            }
        }
